...
**"Visualization of your tidy data"** [Download Brochure](files/workshop.pdf)  
**21 - 22 April 2019**  
**Ombak Villa Resort, Langkawi**  
  
In conjunction with the conferences, the organising committee is conducting a pre-conference workshops on "Visualization of tidy data" and also a two-hour complimentary sharing session on "Machine Learning using R". For registration and further information please refer to the respective link given below.  
...
All interested participant can register through confBay by clicking the following   [![confBay](images/logo-confbay.png)](https://submit.confbay.com/conf/icms2019).  
...
### Workshop Fee  
| Early Bird (Before 15 February 2019) | Regular Price |  
|:-----------|:--------------|  
...
<center>  
[![confBay](images/logo-confbay.png)](https://submit.confbay.com/conf/icms2019).  
</center>  
