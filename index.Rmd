...
*For more information on the conference, please follow this [link](https://uitmicms.wixsite.com/icms2019) or you can download the [conference brochure](files/icms2019.pdf)*
...
In conjunction with the two conferences, the organising committee is conducting a pre-conference workshops on "Visualization of  your tidy data" and also a two-hour complimentary sharing session on "Machine Learning using R". For registration and further information please refer to the respective link given below.  
...
### Registration  
Registration for pre-conference workshop is noe **OPEN**.  
...
Participants are advice to create a confBay account first if you don't have one yet before you are allowed to log in and register.  
