...
In conjunction with the conference, the organising committee is conducting a pre-conference workshop in R. For registration and further information please refer to the respective link given in the registration section below.  
...
*Participants expected to be able to use efficient R code and use R packages to perform data analytics after the workshop.*  
...
All interested participant can register through confBay by clicking the following logo  
<center>  
[![confBay](images/logo-confbay.png)](https://submit.confbay.com/conf/icms2019ws).  
</center>  
Participants are advised to create a confBay account first if you don't have one yet before you are allowed to log in and register.  
